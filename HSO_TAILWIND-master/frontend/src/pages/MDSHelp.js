      ...
      >
        ...
        <nav className="mt-6">
          <ul className="space-y-1">
            <li>
              <a onClick={() => navigate('/mds')} className="flex items-center px-4 py-2 text-white bg-gray-400 rounded"> 
      ...
      <div className="flex-1 flex flex-col">
          <div className={`flex justify-between items-center ${theme === 'dark' ? 'bg-gray-700' : 'bg-maroon'} p-2 rounded-lg shadow mb-4`}>
            ...
            <div className="flex items-center space-x-2 relative">
              <FaChartLine className="w-5 h-5 text-white hover:text-yellow-400 cursor-pointer" onClick={() => navigate('/mAnalytics')} />
